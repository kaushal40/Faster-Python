...
if __name__ == '__main__':
    ...
    # comment condition for if case, if 0 that code won't execute
    if 0:
        bench_login(cases)
    ...
    # this will create the profiler file which will give you visulizations
    # install snakeviz and run `snakeviz prof.out`
    if 0:
        import cProfile
